...
/**
 * Connection establishes a secured TCP connection from a user local to a given remote machine and maintains a pair of
 * ObjectInput and ObjectOutput Streams with that remote machine.
 *
...
public class Connection {
    public ObjectInputStream in = null;   // an output to a remote machine
    ...
    /**
     * This is a constructor executed at a user-local machine to set up a connection to each of remote machines.
     *
     ...
     */
    public Connection(String username, String password, String hostname, String command) {
        try {
    ...
    /**
     * This is a constructor execute at a remote machine to receive a connection from a user-local machine.
     */
    public Connection() {
        try {
    ...
    /**
     * close() is called at a user-local machine to close the ssh connection with a given remote machine.
     */
    public void close() {
        try {
    ...
    /**
     * MyUserInfo stores a user account and password information. It is used in libssh to establish a secured TCP
     * connection from a user-local to a remote machine.
     */
